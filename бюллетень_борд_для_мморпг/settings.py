"""
Django settings for bulletin_board_for_mmorpg project.
...
ROOT_URLCONF = 'bulletin_board_for_mmorpg.urls'
...
WSGI_APPLICATION = 'bulletin_board_for_mmorpg.wsgi.application'
